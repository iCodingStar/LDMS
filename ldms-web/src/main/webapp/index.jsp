...
<div class="main">
    <div class="head">
        <div class="icon">
            <img src="images/logo_head.png" style="width: 1200px;height: 213px">
        </div>
    </div>
    <div class="search">
        <nav class="navbar navbar-default" role="navigation">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">机构与职能<b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a href="http://xgxy.cug.edu.cn/">现任领导</a></li>
                            <li><a href="http://xgxy.cug.edu.cn/">机构设置</a></li>
                            <li><a href="http://xgxy.cug.edu.cn/">专业计划</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">规章制度<b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a href="http://xgxy.cug.edu.cn/">现任领导</a></li>
                            <li><a href="http://xgxy.cug.edu.cn/">机构设置</a></li>
                            <li><a href="http://xgxy.cug.edu.cn/">专业计划</a></li>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">专业概况 <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a href="http://xgxy.cug.edu.cn/">现任领导</a></li>
                            <li><a href="http://xgxy.cug.edu.cn/">机构设置</a></li>
                            <li><a href="http://xgxy.cug.edu.cn/">专业计划</a></li>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">实验室管理 <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a href="http://xgxy.cug.edu.cn/">现任领导</a></li>
                            <li><a href="http://xgxy.cug.edu.cn/">机构设置</a></li>
                            <li><a href="http://xgxy.cug.edu.cn/">专业计划</a></li>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">大型仪器管理 <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a href="http://xgxy.cug.edu.cn/">现任领导</a></li>
                            <li><a href="http://xgxy.cug.edu.cn/">机构设置</a></li>
                            <li><a href="http://xgxy.cug.edu.cn/">专业计划</a></li>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">安全与材料管理<b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a href="http://xgxy.cug.edu.cn/">现任领导</a></li>
                            <li><a href="http://xgxy.cug.edu.cn/">机构设置</a></li>
                            <li><a href="http://xgxy.cug.edu.cn/">专业计划</a></li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <a href="http://localhost:8082/"><button id="tobak" style="width: 100px;height: 36px;margin-top: 4px;text-align: center" class="btn btn-lg btn-info">登录后台</button></a>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
