    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="col-md-2">
                    <button id="btn-order-project-search" class="btn btn-primary btn-lg" style="line-height: 0.8">
                        查询
                    </button>
                </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <table class="table table-hover order-project-info-table">
                    <tr>
                        <td>实验编号</td>
                        <td>授课教师</td>
                        <td>实验名称</td>
            ...
            <div class="panel-footer">
                <div id="score-count" style="display: none;font-family: 微软雅黑;font-size: 16px;margin-right: 10px;text-align: right"></div>
            </div>
        </div>
    </div>
    <!--消息框-->
