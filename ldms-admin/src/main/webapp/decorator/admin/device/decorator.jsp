...
<head>
    ...
    <!--devices-->
    <link rel="stylesheet" href="${cacheUrl}/css/admin/admin-device.css">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="${pageContext.request.contextPath}/admin/teacher/" style="text-align: center"><i
                                class="fa fa-user fa-lg"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;教师管理</a>
                        </li>
                    </ul>
                </li>
...
<script type="text/javascript" src="${cacheUrl}/js/admin/admin-device.js"></script>
</body>
</html>